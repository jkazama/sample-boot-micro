...
public class CashBalanceTest extends EntityTestSupport {
    ...
    public void 現金残高を追加する() {
        ...
        tx(() -> {
            CashBalance cb = fixturesAsset.cb("test1", baseDay, "USD", "10.02").save(rep);
    ...
    public void 現金残高を取得する() {
        ...
        tx(() -> {
            fixturesAsset.cb("test1", baseDay, "JPY", "1000").save(rep);
            fixturesAsset.cb("test2", baseMinus1Day, "JPY", "3000").save(rep);
